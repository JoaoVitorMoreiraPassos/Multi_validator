...
class PassWord(Sequence):
    ...
    def generate(self, level):
        ...
        Função que gera uma senha aleatória e retorna a mesma.
                Parâmetros:
                        level (int): Nível de complexidade da senha.  
    ...
    def validate(self, password):
        ...
        if complexity < 2:
            return "A senha é muito fraca. A senha deve ter pelo menos 2 das seguintes características: letras maiúsculas, letras minúsculas, números ou símbolos.", {"password": password, "complexity": "fraca"}
        elif complexity == 2:
            return "A senha é moderada. A senha tem pelo menos 2 das seguintes características: letras maiúsculas, letras minúsculas, números ou símbolos.", {"password": password, "complexity": "moderada"}
        elif complexity == 3:
            return "A senha é forte. A senha tem pelo menos 3 das seguintes características: letras maiúsculas, letras minúsculas, números ou símbolos.", {"password": password, "complexity": "forte"}
        else:
            return "A senha é muito forte. A senha tem pelo menos 4 das seguintes características: letras maiúsculas, letras minúsculas, números ou símbolos.", {"password": password, "complexity": "muito forte"}
